...
def ensure_pdf_ready():
    ...
    target_name = "Guida_Impegni_e_Conferimento_Grano_Duro.pdf"
    target_path = os.path.join(static_dir, target_name)
    candidates = [
        os.path.join(base_dir, "Guida agli Impegni e Conferimento Grano Duro.pdf"),
        os.path.join(static_dir, "Guida agli Impegni e Conferimento Grano Duro.pdf"),
        os.path.join(base_dir, "static", target_name),
    ]
    for c in candidates:
        if os.path.exists(c):
            if c != target_path:
...
<a href="/app/static/Guida_Impegni_e_Conferimento_Grano_Duro.pdf" download="Guida_Impegni_e_Conferimento_Grano_Duro.pdf" target="_blank" rel="noopener noreferrer" class="hero-law-btn" title="Apri / Scarica Guida agli Impegni e Conferimento Grano Duro (PDF)">
