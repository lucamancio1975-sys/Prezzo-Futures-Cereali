...
st.markdown(f"""
<div class="hero-box">
    <!-- Riga 1: Prezzo e Data a sinistra, Tasto GUIDA a destra -->
    ...
    <!-- Riga 2: Specifiche Tecniche Orizzontali a larghezza piena -->
    ...
    <!-- Riga 3: Delta rispetto a ieri ed eventuale ultimo movimento -->
