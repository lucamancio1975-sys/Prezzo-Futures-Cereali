...
<style>
    ...
    *, *::before, *::after {
    ...
    /* Pulsante Download Nativo Streamlit sotto il grafico */
    .stDownloadButton {
...
pdf_link_attr = f'href="data:application/pdf;base64,{pdf_b64}" download="Guida_Impegni_e_Conferimento_Grano_Duro.pdf"' if pdf_b64 else 'href="#"'
...
<a {pdf_link_attr} class="hero-law-btn" title="Scarica Guida agli Impegni e Conferimento Grano Duro (PDF)">
...
# Pulsante di Download Diretto Nativo Streamlit (garantisce il PDF autentico da 160 KB)
if pdf_bytes:
    st.download_button(
        label="⚖️ Scarica Guida agli Impegni e Conferimento (PDF - 160 KB)",
        data=pdf_bytes,
        file_name="Guida_Impegni_e_Conferimento_Grano_Duro.pdf",
        mime="application/pdf",
        use_container_width=True,
        key="btn_download_guida_pdf"
    )
